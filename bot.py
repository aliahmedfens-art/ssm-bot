...
def invoice_system_menu(chat_id):
    ...
    text += "📌 يمكنك استعراض الفواتير والبحث عنها"
    
    buttons = [
        [{'text': '🔍 بحث عن فاتورة', 'callback_data': 'search_invoice'}],
        [{'text': '📋 فواتير اليوم', 'callback_data': 'today_invoices'}],
